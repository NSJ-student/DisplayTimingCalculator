    ...
    public partial class Form1 : Form
    {
        ...
        private void btnConvert_Click(object sender, EventArgs e)
        {
            ...
            if (rbRefPclk.Checked)
            {
                ...
                if (pclk == 0) { return; }
                fps = ((double)pclk / (double)(htotal * vtotal));
            ...
            rtbScript.AppendText(String.Format("rem_ww2 2 40 01e3 {0:X2}  # Active lines per frame (MSB)\n",
                                                (active_lines_per_frame >> 8) & 0xFF));
            rtbScript.AppendText(String.Format("rem_ww2 2 40 01e4 {0:X2}  # Active lines per frame (LSB) {1}\n",
